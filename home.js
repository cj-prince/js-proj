...
function blackjackDeal() {
    ...
    if (blackjackGame['turnOver'] === true) {
        ...
        document.querySelector('#blackjack-result').stlye.color = 'black';
...
function showScore (activePlayer) {
    if (activePlayer['score'] > 21) {
        ...
        document.querySelector(activePlayer['scoreSpan']).stlye.color = 'red';
    }else{
...
// compute winner , update win draws and losses
